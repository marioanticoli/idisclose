defmodule Idisclose.Accounts.User do
  @moduledoc """
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Idisclose.Repo)
  ...
  """
  def valid_password?(%Idisclose.Accounts.User{hashed_password: hashed_password}, password)
