defmodule IdiscloseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(IdiscloseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(IdiscloseWeb.Gettext, "errors", msg, opts)
    end
  end
